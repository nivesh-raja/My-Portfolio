...
// All tech stack items based on Nivesh Raja R's resume skills
const techStack: TechItem[][] = [
  ...
  [
    ...
    { name: "SQL", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/azuresqldatabase/azuresqldatabase-plain.svg", url: "https://en.wikipedia.org/wiki/SQL" },
  ...
  [
    { name: "Cloud Computing", icon: "https://cdn.jsdelivr.net/gh/devicons/devicon/icons/amazonwebservices/amazonwebservices-original-wordmark.svg", url: "https://aws.amazon.com" },
    { name: "Deep Learning", icon: "https://huggingface.co/front/assets/huggingface_logo-noborder.svg", url: "https://huggingface.co" },
  ],
];
