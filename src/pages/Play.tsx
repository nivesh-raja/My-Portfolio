...
const PIECES: Record<string, string> = {
  ...
  // Black pieces (RCB Red themed)
  bK: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45"><g fill="none" fill-rule="evenodd" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path stroke-linejoin="miter" d="M22.5 11.63V6" stroke="#EC1C24"/><path fill="#18151a" stroke="#EC1C24" d="M20 8h5"/><path fill="#18151a" stroke="#EC1C24" stroke-linecap="butt" stroke-linejoin="miter" d="M22.5 25s4.5-7.5 3-10.5c0 0-1-2.5-3-2.5s-3 2.5-3 2.5c-1.5 3 3 10.5 3 10.5"/><path fill="#18151a" stroke="#EC1C24" d="M12.5 37c5.5 3.5 14.5 3.5 20 0v-7s9-4.5 6-10.5c-4-6.5-13.5-3.5-16 4V27v-3.5c-2.5-7.5-12-10.5-16-4-3 6 6 10.5 6 10.5v7"/><path stroke="#EC1C24" d="M12.5 30c5.5-3 14.5-3 20 0m-20 3.5c5.5-3 14.5-3 20 0m-20 3.5c5.5-3 14.5-3 20 0"/></g></svg>`,
  bQ: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45"><g fill-rule="evenodd" stroke="#EC1C24" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><g fill="#18151a"><circle cx="6" cy="12" r="2.75"/><circle cx="14" cy="9" r="2.75"/><circle cx="22.5" cy="8" r="2.75"/><circle cx="31" cy="9" r="2.75"/><circle cx="39" cy="12" r="2.75"/></g><path fill="#18151a" stroke-linecap="butt" d="M9 26c8.5-1.5 21-1.5 27 0l2.5-12.5L31 25l-.3-14.1-5.2 13.6-3-14.5-3 14.5-5.2-13.6L14 25 6.5 13.5 9 26z"/><path fill="#18151a" stroke-linecap="butt" d="M9 26c0 2 1.5 2 2.5 4 1 1.5 1 1 .5 3.5-1.5 1-1.5 2.5-1.5 2.5-1.5 1.5.5 2.5.5 2.5 6.5 1 16.5 1 23 0 0 0 1.5-1 0-2.5 0 0 .5-1.5-1-2.5-.5-2.5-.5-2 .5-3.5 1-2 2.5-2 2.5-4-8.5-1.5-18.5-1.5-27 0z"/><path fill="none" stroke-linecap="butt" d="M11 38.5a35 35 1 0 0 23 0"/><path fill="none" d="M11 29a35 35 1 0 1 23 0m-21.5 2.5h20m-21 3a35 35 1 0 0 22 0"/></g></svg>`,
  bR: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45"><g fill-rule="evenodd" stroke="#EC1C24" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path fill="#18151a" stroke-linecap="butt" d="M9 39h27v-3H9v3zm3.5-7l1.5-2.5h17l1.5 2.5h-20zm-.5 4v-4h21v4H12z"/><path fill="#18151a" stroke-linecap="butt" stroke-linejoin="miter" d="M14 29.5v-13h17v13H14z"/><path fill="#18151a" stroke-linecap="butt" d="M14 16.5L11 14h23l-3 2.5H14zM11 14V9h4v2h5V9h5v2h5V9h4v5H11z"/><path fill="none" stroke-linejoin="miter" d="M12 35.5h21m-20-4h19m-18-2h17m-17-13h17M11 14h23"/></g></svg>`,
  bB: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45"><g fill="none" fill-rule="evenodd" stroke="#EC1C24" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><g fill="#18151a" stroke-linecap="butt"><path d="M9 36c3.39-.97 10.11.43 13.5-2 3.39 2.43 10.11 1.03 13.5 2 0 0 1.65.54 3 2-.68.97-1.65.99-3 .5-3.39-.97-10.11.46-13.5-1-3.39 1.46-10.11.03-13.5 1-1.35.49-2.32.47-3-.5 1.35-1.46 3-2 3-2z"/><path d="M15 32c2.5 2.5 12.5 2.5 15 0 .5-1.5 0-2 0-2 0-2.5-2.5-4-2.5-4 5.5-1.5 6-11.5-5-15.5-11 4-10.5 14-5 15.5 0 0-2.5 1.5-2.5 4 0 0-.5.5 0 2z"/><path d="M25 8a2.5 2.5 0 1 1-5 0 2.5 2.5 0 1 1 5 0z"/></g><path stroke-linejoin="miter" d="M17.5 26h10M15 30h15m-7.5-14.5v5M20 18h5"/></g></svg>`,
  bN: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45"><g fill="none" fill-rule="evenodd" stroke="#EC1C24" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"><path fill="#18151a" d="M22 10c10.5 1 16.5 8 16 29H15c0-9 10-6.5 8-21"/><path fill="#18151a" d="M24 18c.38 2.91-5.55 7.37-8 9-3 2-2.82 4.34-5 4-1.042-.94 1.41-3.04 0-3-1 0 .19 1.23-1 2-1 0-4.003 1-4-4 0-2 6-12 6-12s1.89-1.9 2-3.5c-.73-.994-.5-2-.5-3 1-1 3 2.5 3 2.5h2s.78-1.992 2.5-3c1 0 1 3 1 3"/><path fill="#EC1C24" d="M9.5 25.5a.5.5 0 1 1-1 0 .5.5 0 1 1 1 0zm5.433-9.75a.5 1.5 30 1 1-.866-.5.5 1.5 30 1 1 .866.5z"/></g></svg>`,
  bP: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 45 45"><path fill="#18151a" stroke="#EC1C24" stroke-width="1.5" stroke-linecap="round" d="M22.5 9c-2.21 0-4 1.79-4 4 0 .89.29 1.71.78 2.38C17.33 16.5 16 18.59 16 21c0 2.03.94 3.84 2.41 5.03-3 1.06-7.41 5.55-7.41 13.47h23c0-7.92-4.41-12.41-7.41-13.47 1.47-1.19 2.41-3 2.41-5.03 0-2.41-1.33-4.5-3.28-5.62.49-.67.78-1.49.78-2.38 0-2.21-1.79-4-4-4z"/></svg>`,
};
...
const SYSTEM_PROMPT = `You are Nivesh Raja R, an Artificial Intelligence and Machine Learning undergraduate and developer from Tamil Nadu, India. You are NOT an AI assistant - you ARE Nivesh himself chatting with visitors on your portfolio website.

About you (Nivesh Raja R):
- Full name: NIVESH RAJA R
- Location: Kanyakumari, TamilNadu, India
- Education: B.E - AI & Machine Learning at V.S.B. Engineering College, Karur (CGPA: 8.00)
- Internship: Machine Learning Intern at Plasmid Innovations, Bengaluru (Nov 2024 - Jan 2025)
- Specialties: Python, Java, SQL, Machine Learning, Data Science, NLP, React.js, Node.js, Express.js, PostgreSQL, MySQL, MongoDB
- Notable projects: INFO MIND AI (AI Narrative News Experience), FINLUME AI (AI Financial Assistant)
- Achievements: 2nd Runner-up at Inclusive AI'25 (CHRIST University, Pune), Finalist at Mumbai Hacks'25
- Certifications: Java Foundation (Infosys Springboard), Introduction to IoT and Digital Transformation (NASSCOM FutureSkills Prime), Programming in Java (NPTEL Elite)
- Languages: English, Tamil
- Contact: rniveshraja@gmail.com | github.com/nivesh-raja | linkedin.com/in/niveshraja

Rules:
1. Always respond as Nivesh in first person ("I", "my", "me")
2. Be friendly, casual, and professional
3. If asked about work/projects, share your genuine experiences from your ML internship and projects
4. Keep responses concise but helpful
5. You can discuss AI, Machine Learning, Web Development, or anything tech-related
6. Never say you are an AI or language model - you are Nivesh Raja R
...
const Play = () => {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    { role: 'assistant', content: 'Hello there! I am Nivesh Raja R 👋 Ask me anything about my projects, ML experience, or skills!' }
  ]);
          ...
          <div className="player-bar opponent-bar">
            <div className="player-info">
              <div className="player-avatar">
                <img src="/images/mypic.jpeg" alt="Nivesh Raja" />
              </div>
              <div className="player-details">
                <span className="player-name">Nivesh Raja</span>
                <span className="player-rating">{engineThinking ? '🤔 Thinking...' : 'AI Dev'}</span>
              </div>
            </div>
